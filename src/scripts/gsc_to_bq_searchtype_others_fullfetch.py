...
# Revision: Rev.6.3 - Converting ISO 3166 Alpha-2 Codes country values to full Country Name.
...
BQ_TABLE = "00_06__temp_bamtabridsazan__gsc__raw_domain_data_othersearchtype_fullfetch__base_layer"
ROW_LIMIT = 25000
        ...
        if not exists_for_date:
            for stype in SEARCH_TYPES:
                ...
                if unique_key not in existing_keys:
                    ...
                    print(f"[INFO] Batch 8, Sitewide: adding placeholder for missing date {date_str} (stype={stype})", flush=True)
